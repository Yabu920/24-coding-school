// // app/teacher-dashboard/assignments/components/AssignmentEditForm.tsx
// "use client";
...
// export default function AssignmentEditPage({ assignmentId }: { assignmentId: string }) {
...
//         setDueDate(data.assignment.due_date ?? null);
//       } catch (err: any) {
//         console.error(err);
//         setMessage(err.message || "Failed to load assignment");
//       } finally {
//         setLoading(false);
//       }
//     };
