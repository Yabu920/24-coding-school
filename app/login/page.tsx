...
//   //     // Get the real role from the session to avoid relying on the selected tab
...
//     // Fetch updated session once, now that login succeeded
//     const session = await fetch("/api/auth/session", { cache: "no-store" })
//       .then((r) => r.ok ? r.json() : null)
//       .catch(() => null);
...
//     // Redirect based on actual role from session, not selected tab
