...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var email, username, existing, password_hash, admin;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    email = "admin@24codingschool.com";
                    username = "admin";
                    return [4 /*yield*/, prisma_1.prisma.users.findFirst({ where: { OR: [{ email: email }, { username: username }] } })];
                case 1:
                    existing = _a.sent();
                    if (existing) {
